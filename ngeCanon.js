...
(function (root, factory) {
    ...
    var canonItems = [
        ...
        },
        {
            alphanumeric: '2',
            term: 'Wisdom',
            meaning: '(also in alphabet) Wisdom is the manifestation of ones knowledge, the ways and actions one uses to make his or her knowledge to know the truth, such as speaking wisely to the wise, to the dumb or to possess a wise Mind. Wisdom is the woman.'
        },
        {
            alphanumeric: '3',
            term: 'Understanding',
